...
public class SizeUtil {
  ...
  public static String getHeight(FigmaNode fNode, FigmaNode mainScreen, FlutterGI flutterGI) {
  ...
  public static String getWidth(FigmaNode fNode, FigmaNode mainScreen, FlutterGI flutterGI) {
    if (fNode.getConstraints() != null) {
