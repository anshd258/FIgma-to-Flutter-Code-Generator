...
@Service
@Slf4j
public class SwitchTagCGI implements FlutterCGI{
    @Override
    ...
    private String generat(FigmaRectangleNode fNode) {
        final String upperStateFullWidget = "class CustomSwitch extends StatefulWidget {\n" +
                "  \n" +
                "\n" +
                "  @override\n" +
    ...
    private String getWidgetBuild(FigmaRectangleNode fNode) {
        final String upperWidgetBuild = "@override\n" +
    ...
    private String getpadding(FigmaRectangleNode fNode) {
        final String upperPadding = "Padding(\n" +
    ...
    private String getInitState(FigmaRectangleNode fNode) {
        final String upperInitState =  "  @override\n" +
                "  void initState() {\n" +
                "    super.initState();\n" +
        ...
        final String middleInitState = ");\n" +
                ...
                "      begin: Offset(0, 0),\n" +
                "      end:";
        final String endInitState =  ").animate(CurvedAnimation(\n" +
                "      parent: _controller,\n" +
    ...
    private String getDispose() {
        final String disposeMethod = "@override\n" +
                "  void dispose() {\n" +
                "    _controller.dispose();\n" +
                "    super.dispose();\n" +
                "  }";
