...
public class AutoLayoutFrameCGI {
  ...
  public String generateAutoLayoutFrame(
    ...
    Map<String, Boolean> hugAndFillProperties = new HashMap<>();
    ...
    switch (layoutMode) {
      case VERTICAL -> genCode.append(
          getColumn(genCode, figmaNode, flutterNecleoDataNode, flutterGI, hugAndFillProperties));
      case HORIZONTAL -> {
        switch (layoutWrap) {
          case WRAP -> genCode.append(
              getWrap(genCode, figmaNode, flutterNecleoDataNode, flutterGI, hugAndFillProperties));
      ...
      case NONE -> genCode.append(
          getContainerWidget(genCode, figmaNode, flutterNecleoDataNode, flutterGI));
    }
  ...
  private StringBuilder wrapWithMultipleParent(
      int parentNumber, ArrayList<String> name, StringBuilder genCode) {
  ...
  private String getWrap(
    ...
    if ((hugAndFillProperties.get("fillVertically") && hugAndFillProperties.get("fillHorizontally"))
