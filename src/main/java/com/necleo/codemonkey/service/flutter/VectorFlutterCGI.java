...
public class VectorFlutterCGI implements FlutterCGI{
  RectangleFlutterCGI rectangleFlutterCGI;
    ...
    private String getClipperPath(FigmaVectorNode figmaNode) {
        final String upperClipper = "class MyClipper extends CustomClipper<Path> {\n" +
                "  final String pathData;\n" +
                "\n" +
                "  MyClipper(\n" +
                "      {this.pathData ='" + figmaNode.getFillGeometry().get(0).getData()+ "'});\n";
      final String lowerClipper = "  @override\n" +
